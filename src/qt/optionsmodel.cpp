...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizePentacoinAmount:
            nAnonymizePentacoinAmount = value.toInt();
            settings.setValue("nAnonymizePentacoinAmount", nAnonymizePentacoinAmount);
            emit anonymizePentacoinAmountChanged(nAnonymizePentacoinAmount);
            break;
        default:
            break;
        }
